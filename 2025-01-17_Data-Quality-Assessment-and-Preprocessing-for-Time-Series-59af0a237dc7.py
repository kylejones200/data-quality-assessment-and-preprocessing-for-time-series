...
plt.scatter(
    df[anomalies]["timestamp"], df[anomalies]["value"], color="red", label="Anomalies"
)
...
def preprocess_time_series(df, timestamp_col, value_col, target_freq="D"):
    ...
    df_regular["forward_fill"] = df_regular[
        value_col
...
plt.plot(
    preprocessed_df.index,
    preprocessed_df["linear_interpolation"],
    label="Linear Interpolation",
    linewidth=2,
)
plt.plot(
    preprocessed_df.index,
    preprocessed_df["forward_fill"],
    label="Forward Fill",
    linewidth=2,
)
plt.plot(
    preprocessed_df.index,
    preprocessed_df["rolling_mean"],
    label="Rolling Mean",
    linewidth=2,
)
